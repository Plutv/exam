  ...
  <div id="myExam">
    ...
    <div class="wrapper">
      <ul class="top">
        ...
        <li class="search-li"><div class="icon"><input type="text" placeholder="输入试卷名称" class="search" v-model="key"><i class=""></i></div></li>
      ...
      <ul class="paper" v-loading="loading">
        <li class="item" v-for="(item,index) in pagination.records" :key="index">
          ...
          <div class="info">
            <i class=""></i><span>{{item.examDate.substr(0,10)}}</span>
            <i class=""></i><span v-if="item.totalTime != null">限时{{item.totalTime}}分钟</span>
            <i class=""></i><span>满分{{item.totalScore}}分</span>
          </div>
        </li>
      </ul>
